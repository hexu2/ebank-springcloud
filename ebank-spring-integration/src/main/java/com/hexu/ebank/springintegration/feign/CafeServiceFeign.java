package com.hexu.ebank.springintegration.feign;
...
@RequestMapping("springIntegrationFeign/v1/cafe")
@RestController
public class CafeServiceFeign {


    private static final Logger logger = LoggerFactory.getLogger(CafeServiceFeign.class);
